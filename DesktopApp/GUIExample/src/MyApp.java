        ...
        collapseButton.addActionListener(actionEvent -> {
            if (collapseButton.getText().equals("Collapse")) {
                if (name.getText().isEmpty() || surname.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(mainPanel, "Заполните Имя и Фамилия");
                } else {
                ...
                if (fio.length > 3) {
                    JOptionPane.showMessageDialog(mainPanel, "ФИО не может состоять более, чем из трёх слов");
                } else if (fio.length < 2) {
                    JOptionPane.showMessageDialog(mainPanel, "ФИО не может состоять менее, чем из двух слов");
                } else {
